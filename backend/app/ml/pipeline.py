...
import logging
from collections import defaultdict as zones_defaultdict
...
async def process_submission_pipeline(submission: Submission, db: AsyncSession):
    ...
    if app_settings.pipeline_v2_enabled:
...
async def _load_template_context(
    ...
    zones_by_page: dict[int, list[TemplateZone]] = zones_defaultdict(list)
